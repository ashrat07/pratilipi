 ...
 * @param <Result>
 */
public class QueueableAsyncTask<Params, Progress, Result> extends
		AsyncTask<Params, Progress, Option<Result>> {

	public static interface QueueCallback {
		void taskCompleted(QueueableAsyncTask<?, ?, ?> task,
	 ...
	 * @return this object
	 */
	public QueueableAsyncTask setOnCancelled(
			Command<Option<Result>> onCancelledOperation) {
		this.onCancelledOperation = onCancelledOperation;
		return this;
	}

	public QueueableAsyncTask setOnPostExecute(
			Command<Option<Result>> onPostExecuteOperation) {
	...
	public void setOnProgressUpdate(
			Command<Progress[]> onProgressUpdateOperation) {
