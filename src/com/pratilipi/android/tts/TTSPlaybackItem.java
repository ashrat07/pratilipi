...
package com.pratilipi.android.tts;
...
public class TTSPlaybackItem {
	...
	public TTSPlaybackItem(CharSequence text, MediaPlayer mediaPlayer,
			int totalTextLength, int offset, boolean lastElementOfPage,
			String fileName) {
		this.text = text;
	...
	public void setOnSpeechCompletedCallback(
			final SpeechCompletedCallback callback) {
		// this.mediaPlayer.setOnCompletionListener(
		// mediaPlayer -> callback.speechCompleted(TTSPlaybackItem.this,
		// mediaPlayer)
		// );
		this.mediaPlayer
				.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
					...
					public void onCompletion(MediaPlayer mediaPlayer) {
						callback.speechCompleted(TTSPlaybackItem.this,
								mediaPlayer);
					}
				});
	}
