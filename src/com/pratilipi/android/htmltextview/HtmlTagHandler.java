...
package com.pratilipi.android.htmltextview;
...
public class HtmlTagHandler implements Html.TagHandler {
	...
	/**
	 * Tracks indexes of ordered lists so that after a nested list ends we can
		...
		if (opening) {
			...
			if (tag.equalsIgnoreCase("ul")) {
				...
				if (lists.peek().equalsIgnoreCase("ul")) {
					...
					// Nested BulletSpans increases distance between bullet and
					// text, so we must prevent it.
				...
				end(output, Center.class, true, new AlignmentSpan.Standard(
	...
	private void end(Editable output, Class kind, boolean paragraphStyle,
		...
		if (where != len) {
			...
			for (Object replace : replaces) {
				output.setSpan(replace, where, thisLen,
