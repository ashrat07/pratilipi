...
public interface PageChangeStrategy {
	...
	/**
	 * Tells this strategy to move the window so the specified position ends up
	 * on the top line of the windows.
	 * 
	 * @param pos
	 */
	...
	/**
	 * Sets a position relative to the text length: 0 means the start of the
	 * text, 1 means the end of the text.
	 * 
	 * @param position
	...
	/**
	 * Gets the text for the next page to be displayed, or null if we've reached
	 * the end.
	 * 
	 * @return
	 */
	...
	/**
	 * Gets the text for the previous page to be displayed, or null if we've
	 * reached the start.
	 * 
	 * @return
	 */
