...
public interface BookViewListener {
	...
	/**
	 * Called when the BookView starts parsing a new entry of the book. Usually
	 * after a pageUp or pageDown event.
	 * 
	 * @param entry
	 */
	 ...
	 * 
	 * This will always be called when the user taps the screen, even when an
	 * edge is tapped.
	 */
	void onScreenTap();
