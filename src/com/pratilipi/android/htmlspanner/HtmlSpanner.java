...
import com.pratilipi.android.htmlspanner.exception.ParsingCancelledException;
import com.pratilipi.android.htmlspanner.handlers.FontHandler;
import com.pratilipi.android.htmlspanner.handlers.HeaderHandler;
import com.pratilipi.android.htmlspanner.handlers.ImageHandler;
import com.pratilipi.android.htmlspanner.handlers.LinkHandler;
import com.pratilipi.android.htmlspanner.handlers.ListItemHandler;
import com.pratilipi.android.htmlspanner.handlers.MonoSpaceHandler;
import com.pratilipi.android.htmlspanner.handlers.NewLineHandler;
import com.pratilipi.android.htmlspanner.handlers.PreHandler;
import com.pratilipi.android.htmlspanner.handlers.StyleNodeHandler;
import com.pratilipi.android.htmlspanner.handlers.StyledTextHandler;
import com.pratilipi.android.htmlspanner.handlers.SubScriptHandler;
import com.pratilipi.android.htmlspanner.handlers.SuperScriptHandler;
import com.pratilipi.android.htmlspanner.handlers.attributes.AlignmentAttributeHandler;
import com.pratilipi.android.htmlspanner.handlers.attributes.BorderAttributeHandler;
import com.pratilipi.android.htmlspanner.handlers.attributes.StyleAttributeHandler;
...
public class HtmlSpanner {
	...
	private void registerBuiltInHandlers() {
		...
		TagNodeHandler marginHandler = new StyledTextHandler(
				new Style().setMarginLeft(new StyleValue(2.0f,
						StyleValue.Unit.EM)));
		...
		TagNodeHandler pHandler = new BorderAttributeHandler(
				wrap(new StyledTextHandler(paragraphStyle)));
		...
		TagNodeHandler centerHandler = new StyledTextHandler(
				new Style().setTextAlignment(Style.TextAlignment.CENTER));
