...
import com.pratilipi.android.htmlspanner.VerticalMarginSpan;
import com.pratilipi.android.htmlspanner.style.Style;
import com.pratilipi.android.htmlspanner.style.StyleCallback;
...
public class StyledTextHandler extends TagNodeHandler {
	...
	public void handleTagNode(TagNode node, SpannableStringBuilder builder,
		...
		if (builder.length() > start) {
			...
			Log.d("StyledTextHandler", "Refusing to push span of length "
