...
public class CatalogBookDetailsActivity extends PageTurnerActivity implements
		CatalogParent {
	...
	protected void onCreatePageTurnerActivity(Bundle savedInstanceState) {
		...
		detailsFragment = (BookDetailsFragment) getSupportFragmentManager()
				.findFragmentById(R.id.fragment_bookdetails);
