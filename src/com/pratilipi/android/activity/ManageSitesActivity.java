...
public class ManageSitesActivity extends ListActivity {
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
		...
		menu.add(Menu.NONE, ContextAction.EDIT.ordinal(), Menu.NONE,
				R.string.edit);
		menu.add(Menu.NONE, ContextAction.DELETE.ordinal(), Menu.NONE,
				R.string.delete);
	...
	private void showSiteDialog(int titleResource,
			final CustomOPDSSite siteParam) {
		...
		final TextView siteDesc = (TextView) layout
				.findViewById(R.id.siteDescription);
		...
		// Toast.makeText(ManageSitesActivity.this, R.string.msg_name_blank,
		// Toast.LENGTH_SHORT).show();
		// return;
		// }
		//
		// if ( siteURL.getText().toString().trim().length() == 0 ) {
		// Toast.makeText(ManageSitesActivity.this, R.string.msg_url_blank,
		// Toast.LENGTH_SHORT).show();
		// return;
		// }
		//
		...
		builder.setPositiveButton(R.string.save,
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						if (siteName.getText().toString().trim().length() == 0) {
							Toast.makeText(ManageSitesActivity.this,
									R.string.msg_name_blank, Toast.LENGTH_SHORT)
									.show();
							return;
						}
						...
						if (siteURL.getText().toString().trim().length() == 0) {
							Toast.makeText(ManageSitesActivity.this,
									R.string.msg_url_blank, Toast.LENGTH_SHORT)
									.show();
							return;
						}
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView != null) {
				...
				view = ((LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE))
						.inflate(R.layout.manage_sites, null);
			}
