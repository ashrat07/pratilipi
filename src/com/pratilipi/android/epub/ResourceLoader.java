 ...
 * 
 * We don't want to load all the images from an EPUB at once, but lazy-loading
 * several images and opening the file for each is too slow.
 * 
 * The image loader allows a class to register call-backs so several images can
 * be loaded in a single go.
 * 
 * @author Alex Kuiper
 * 
 */
