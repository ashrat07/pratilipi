 ...
 */
package com.pratilipi.android.animation;
...
public class PageTimer implements Animator {
	...
	public void draw(Canvas canvas) {
		...
		Rect fullScreen = new Rect(0, 0, backgroundImage.getWidth(),
		...
		int timerHeight = 10;
		Rect timer = new Rect(0, backgroundImage.getHeight()
				- (timerHeight + bottom), backgroundImage.getWidth(),
				backgroundImage.getHeight() - bottom);
