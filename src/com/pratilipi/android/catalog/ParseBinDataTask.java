...
public class ParseBinDataTask extends
	...
	public void doOnPostExecute(Option<FastBitmapDrawable> result) {
		...
		result.forEach(new Command<FastBitmapDrawable>() {

			public void execute(FastBitmapDrawable r) {
				callBack.notifyLinkUpdated(imageLink, r);
			};
		});
	}
