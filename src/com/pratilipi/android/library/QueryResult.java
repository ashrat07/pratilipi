...
/**
 * A QueryResult maps a Cursor and performs basic O/R mapping.
 * 
 * Subclasses should implement the actual mapping from a row to an object by
 * overriding convertRow()
 * 
 * @author Alex Kuiper
 * 
 * @param <T>
