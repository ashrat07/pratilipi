...
public class ProfileLanguageFragment extends BaseFragment {
	...
	public View onCreateView(LayoutInflater inflater,
		...
		// Toast.makeText(mParentActivity, "clicked", 10).show();
		...
		mViewPager.setAdapter(new ProfileLanguageFragmentPagerAdapter(mParentActivity.getSupportFragmentManager(),mParentActivity));
